...
public class MainActivity extends BaseActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    @BindView(R.id.feature_notify_img1)
    ImageView mFeatureNotifyImg1;
    @BindView(R.id.sw_notify_enable_inner_app)
    Switch mSwNotifyEnableInnerApp;
    @BindView(R.id.rl_corner_enable_inner_app)
    RelativeLayout mRlCornerEnableInnerApp;
    ...
    @OnClick(R.id.rl_corner_enable_inner_app)
    void onClickCornerInnerApp(){
    ...
    @OnClick(R.id.change_color_layout)
    void chooseColor() {
